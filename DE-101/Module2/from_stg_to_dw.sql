...
inner join dw.geo_dim g on o.postal_code::int = g.postal_code::int and g.country=o.country and g.city = o.city and o.state = g.state --City Burlington doesn't have postal code
